...
Read [Hide results](../reference/hide-results) for the full discriminated union.

Read [Accessibility](../guides/accessibility) for focus order, explicit close controls, stacked
...
See [Gestures and scroll](../guides/gestures-and-scroll) for the shared behavior.
