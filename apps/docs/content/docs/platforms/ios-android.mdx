...
Expo projects should use the [Expo guide](./expo). In a bare React Native project, install every
peer:
...
<Cards>
  <Card title="Hide results" href="../reference/hide-results" />
  <Card title="Gestures and scroll" href="../guides/gestures-and-scroll" />
  <Card title="Native iOS overlays" href="../guides/native-overlays" />
</Cards>
