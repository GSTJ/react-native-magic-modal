---
title: magicModal
description: Show, hide, update, and configure modals imperatively from any part of the app.
---
...
See [hide results](./hide-results) for promise narrowing and [update open content](../guides/updating-content)
for remount behavior.
