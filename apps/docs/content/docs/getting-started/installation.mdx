...
Continue with the [Expo Web setup](../platforms/expo#expo-web).
...
Continue with the [Expo iOS setup](../platforms/expo#expo-ios).
...
Continue with the [Expo Android setup](../platforms/expo#expo-android). The iOS and Android commands
...
The [Next.js guide](../platforms/nextjs) contains the validated Turbopack alias, extension order,
