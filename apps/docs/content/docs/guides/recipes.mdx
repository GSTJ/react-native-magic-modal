...
For a high-volume notification queue, use a dedicated toast library. This pattern is useful when
the notification belongs to the same modal orchestration flow.
